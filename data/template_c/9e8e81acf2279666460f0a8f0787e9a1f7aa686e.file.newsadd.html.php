<?php /* Smarty version Smarty-3.1.16, created on 2017-05-23 05:21:51
...
">
							...
							<fieldset style="width:48%; float:left;">
								<label>出处</label>
								<input type="text" name="fromS" style="width:92%;" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['fromS'])===null||$tmp==='' ? '' : $tmp);?>
">
